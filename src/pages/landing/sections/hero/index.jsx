...
export const Hero = () => {
  return (
    <section className="mt-[5rem] p-5 md:p-[7.5rem] text-white relative flex flex-col justify-center flex-1 gap-8 bg-main-dark-bg bg-no-repeat bg-hero-squiggle bg-invert">
      <div className="flex flex-col items-center gap-8 h-[81vh] md:h-[85vh] p-5 md:max-w-[28.563rem] md:m-auto md:bg-bg-hero-squiggle md:bg-contain bg-no-repeat bg-center ">
        <motion.h1
          {...framer_title}
      ...
      <div className="hidden sm: block absolute top-1/2 transform -translate-y-1/2 left-0 w-[30%] h-full bg-no-repeat bg-center bg-illustration-hero-left opacity-50"></div>
      <div className="hidden sm: block absolute top-1/2 transform -translate-y-1/2 right-0 w-[30%] h-full bg-no-repeat bg-center bg-illustration-hero-right opacity-50"></div>
    </section>
  );
};

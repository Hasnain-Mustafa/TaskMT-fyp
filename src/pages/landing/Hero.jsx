...
const Hero = () => {
  ...
  return (
    <section className="mt-[3.4rem] m-auto flex justify-between">
      <div className="flex flex-col gap-40 md:items-center justify-between md:flex-row w-full">
        ...
        <img className="h-[27rem] w-[27rem] ml-4" src={HeroImg} alt="" />
      </div>
    </section>
  );
};

...
const renderProgress = (props) => {
  if (!props || !props.ProjectName) {
    // Handle the case where props or props.ProjectName is null or undefined
    return null; // Or any other fallback UI
  }

  const { ProjectName } = props;
  // Retrieve progress data for the project (assuming it's available in customersData)
  const project = customersData.find((customer) => customer.ProjectName === ProjectName);
  const progress = project ? project.Progress : 0; // Assuming progress is a number between 0 and 100

  let progressBarColor;
  if (progress < 50) {
    progressBarColor = '#ff0000'; // Red color for progress less than 50%
  } else if (progress >= 50 && progress < 100) {
    progressBarColor = '#ffff00'; // Yellow color for progress between 50% and 99%
  } else {
    progressBarColor = '#00ff00'; // Green color for progress 100%
  }
...
export const customersGrid = [
    ...
    { field: 'EmployeeID', headerText: 'Employee ID', width: '150', textAlign: 'Center', isPrimaryKey: true },
    { field: 'Name', headerText: 'Name', width: '200', template: customerGridImage, textAlign: 'Center' },
    ...
    { field: 'Progress', headerText: 'Progress', width: '120', template: renderProgress, textAlign: 'Center' }
  ];
...
export const customersData = [
  {
    ...
    Weeks: '40',
    Budget: '$2.4k',
    Progress: 80, // Progress set to 80%
  },
  {
    EmployeeID: 1002,
    ...
    Weeks: '11',
    Budget: '$3.9k',
    Progress: 60, // Progress set to 60%
  },
  {
    EmployeeID: 1003,
  ...
  },
  {
    ...
    Weeks: '34',
    Budget: '$16.5k',
    Progress: 100, // Progress set to 100%
  },
  {
    EmployeeID: 1005,
    ...
    Weeks: '34',
    Budget: '$16.5k',
    Progress: 30, // Progress set to 30%
  },
  // Add more data as needed with Progress set to appropriate values
  {
    EmployeeID: 1006,
    ...
    Weeks: '25',
    Budget: '$5.2k',
    Progress: 20, // Progress set to 20%
  },
  {
    EmployeeID: 1007,
    ...
    Weeks: '15',
    Budget: '$8.7k',
    Progress: 70, // Progress set to 70%
  },
  {
    EmployeeID: 1008,
    ...
    Weeks: '40',
    Budget: '$12.9k',
    Progress: 50, // Progress set to 50%
  }
];
